        ...
        <>
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="absolute inset-0 -z-10 bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100">
                    {/* Animated mesh gradient */}
                    <div className="absolute inset-0 opacity-30">
                        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
                        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-indigo-300 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
