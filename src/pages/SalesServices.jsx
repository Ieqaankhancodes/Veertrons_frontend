              ...
              <div className="flex flex-wrap justify-center gap-3 mb-10">
                {serviceTypes.map((type) => (
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${selectedServiceType === type
                ...
                <div className="bg-white rounded-[3rem] p-8 md:p-10 shadow-xl shadow-slate-200/60 border border-slate-100">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full py-5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all duration-300 shadow-lg shadow-blue-600/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
